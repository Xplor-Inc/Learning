$basePath = "../src/Presentation/BlazorApp/"
...
dotnet publish "../src/XploringMe.sln" -c Release -r win-x86 --self-contained true --output $outputPath
...
Compress-Archive -Path ($outputPath+"\*") -Force -DestinationPath $outputPath".zip"
